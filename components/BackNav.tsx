    ...
    <>
      ...
      <div className="flex items-center gap-3 min-w-0">
        <Link
          ...
          className="shrink-0 w-8 h-8 flex items-center justify-center rounded-lg transition-colors hover:bg-[rgba(26,23,20,0.07)] text-text-muted hover:text-text-secondary"
        >
              ...
              <span key={i} className="flex items-center gap-1.5 min-w-0">
                {i > 0 && (
                  <svg width="5" height="9" viewBox="0 0 5 9" fill="none" aria-hidden className="shrink-0 opacity-30">
                    <path d="M1 1l3 3.5L1 8" stroke="#1A1714" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                )}
                {isLast ? (
        ...
        <div className="fixed bottom-6 left-6 z-50 no-print floating-back-safe">
          <button
            ...
            style={{
              ...
              background: '#1A1714',
              color: '#FFFFFF',
              boxShadow: '0 8px 28px rgba(26,23,20,0.30), 0 2px 6px rgba(26,23,20,0.15)',
            }}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden>
