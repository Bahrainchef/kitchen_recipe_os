...
insert into public.venues (
  ...
  (
    ...
    0,           -- pinned alongside OTOD on dashboard
    null
  ),
  ...
  (
    ...
    'One Team One Dream',
    'OTOD',
    'Personal recipe collection — a lifetime of culinary inspiration across world cuisines',
    'pastry_hub',
    null, null,
    '#8B2635',   -- deep burgundy
    0.00,
    -1,          -- pinned before Pastry Hub on dashboard
    null
  );
...
insert into public.sections (id, venue_id, name, sort_order) values
  ...
  ('b1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000008', 'Bakery & Breads',      2),
  ...
  ('b1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000008', 'Travel Cakes & Gateau Voyage', 5),
  ...
  ('b1000000-0000-0000-0000-000000000112', 'a1000000-0000-0000-0000-000000000008', 'Cookies & Biscuits',    12),
  ('b1000000-0000-0000-0000-000000000119', 'a1000000-0000-0000-0000-000000000008', 'Ramadan',               13),
  ...
  ('b1000000-0000-0000-0000-000000000034', 'a1000000-0000-0000-0000-000000000003', 'Mezza',            5),
  ...
  ('b1000000-0000-0000-0000-000000000056', 'a1000000-0000-0000-0000-000000000005', 'Coffee Break',     8),  -- icon: ☕
  ...
  ('b1000000-0000-0000-0000-000000000062', 'a1000000-0000-0000-0000-000000000006', 'Pasta',            3),
...
-- =============================================================================
-- ONE TEAM ONE DREAM — SECTIONS
-- =============================================================================

insert into public.sections (id, venue_id, name, icon, sort_order) values
  ('d0000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000009', 'Basic Recipes',            '📋',  1),
  ('d0000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000009', 'Arabic',                   '🌙',  2),
  ('d0000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000009', 'Lebanese & Iranian',        '🫙',  3),
  ('d0000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000009', 'Breakfast',                '🍳',  4),
  ('d0000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000009', 'Indian',                   '🪔',  5),
  ('d0000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000009', 'Dumplings & Wontons',      '🥟',  6),
  ('d0000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000009', 'Moroccan',                 '🏺',  7),
  ('d0000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000009', 'Burgers & Sandwiches',     '🍔',  8),
  ('d0000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000009', 'Soups',                    '🍲',  9),
  ('d0000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000009', 'Salads',                   '🥗', 10),
  ('d0000000-0000-0000-0000-000000000011', 'a1000000-0000-0000-0000-000000000009', 'Food Truck',               '🚚', 11),
  ('d0000000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000009', 'BBQ Rubs & BBQ Sauces',    '🔥', 12),
  ('d0000000-0000-0000-0000-000000000013', 'a1000000-0000-0000-0000-000000000009', 'Savoury European Kitchen', '🍽️', 13),
  ('d0000000-0000-0000-0000-000000000014', 'a1000000-0000-0000-0000-000000000009', 'Al-Najda Bahraini',        '🇧🇭', 14),
  ('d0000000-0000-0000-0000-000000000015', 'a1000000-0000-0000-0000-000000000009', 'Chutneys & Relish',        '🫙', 15),
  ('d0000000-0000-0000-0000-000000000016', 'a1000000-0000-0000-0000-000000000009', 'Chinese',                  '🥢', 16),
  ('d0000000-0000-0000-0000-000000000017', 'a1000000-0000-0000-0000-000000000009', 'Greg Malouf',              '📖', 17),
  ('d0000000-0000-0000-0000-000000000018', 'a1000000-0000-0000-0000-000000000009', 'Zahav Restaurant',         '📖', 18),
  ('d0000000-0000-0000-0000-000000000019', 'a1000000-0000-0000-0000-000000000009', 'Pasta & Pizza',            '🍝', 19),
  ('d0000000-0000-0000-0000-000000000020', 'a1000000-0000-0000-0000-000000000009', 'Thai / Korean / Japanese', '🥢', 20),
  ('d0000000-0000-0000-0000-000000000021', 'a1000000-0000-0000-0000-000000000009', 'Ramadan Sides',            '🌙', 21);


-- =============================================================================
-- PASTRY HUB SECTION ICONS  (run after initial seed to set emoji icons)
-- =============================================================================

update public.sections set icon = '🍞' where id = 'b1000000-0000-0000-0000-000000000002';  -- Bakery & Breads
update public.sections set icon = '🧳' where id = 'b1000000-0000-0000-0000-000000000005';  -- Travel Cakes & Gateau Voyage
update public.sections set icon = '🍪' where id = 'b1000000-0000-0000-0000-000000000112';  -- Cookies & Biscuits
update public.sections set icon = '☕' where id = 'b1000000-0000-0000-0000-000000000056';  -- Coffee Break (SSL KSA)


-- =============================================================================
-- LIVE DATABASE MIGRATION  (run in Supabase SQL Editor to apply these changes)
-- =============================================================================
-- Rename Bakery → Bakery & Breads
-- update public.sections set name = 'Bakery & Breads', icon = '🍞', updated_at = now()
--   where id = 'b1000000-0000-0000-0000-000000000002';
--
-- Rename Doughs → Travel Cakes & Gateau Voyage
-- update public.sections set name = 'Travel Cakes & Gateau Voyage', icon = '🧳', updated_at = now()
--   where id = 'b1000000-0000-0000-0000-000000000005';
--
-- Bump Ramadan from sort 12 → 13
-- update public.sections set sort_order = 13, updated_at = now()
--   where id = 'b1000000-0000-0000-0000-000000000119';
--
-- Add Cookies & Biscuits at sort 12
-- insert into public.sections (id, venue_id, name, icon, sort_order)
--   values ('b1000000-0000-0000-0000-000000000112', 'a1000000-0000-0000-0000-000000000008',
--           'Cookies & Biscuits', '🍪', 12)
--   on conflict (id) do update set name = excluded.name, icon = excluded.icon, sort_order = excluded.sort_order, updated_at = now();
