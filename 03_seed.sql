...
insert into public.sections (id, venue_id, name, sort_order) values
  ...
  ('b1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000008', 'Base Recipes',    3),
  ...
  ('b1000000-0000-0000-0000-000000000066', 'a1000000-0000-0000-0000-000000000006', 'The Box Exclusives', 7),  -- TFJ The Box additional dishes
...
-- select count(*) as section_count from public.sections;            -- expect 50
